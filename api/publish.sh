...
# Deployment IDs (clasp deployments to confirm):
#   API  @68: AKfycbwu2VJv9zMJz3GSb7ijyLqrQzvwweJjS9hP6EFAB9Aao4MNo4vl2zgEil-GcBNACQxp
#   Addon @51: AKfycbxPMikpb1W7qHCYwuIfx1696rU-rsnZka_SRhdSL6x8r8EnhRVbwQ1Kofdjm8jIFcaL
DEPLOYMENT_ID="AKfycbwu2VJv9zMJz3GSb7ijyLqrQzvwweJjS9hP6EFAB9Aao4MNo4vl2zgEil-GcBNACQxp"
...
clasp deploy -i "$DEPLOYMENT_ID" -d "PMC Estimator API v$NEXT_VERSION — QA gate passed"
