 ...
 * Run: node cp-engine/test.js  (from repo root)
 *
 * Test coverage:
...
// Load real invertCdf and ensureSortedMonotoneCdf from saco-browser engine
loadGS('../saco-browser/helpers/metrics.js');
