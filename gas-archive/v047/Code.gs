...
function showPlotWrapper() {
    ...
    try {
                    ...
                    `<script>
                        function openDashboard() {
                            try {
                                ...
                                alert('Failed to open dashboard automatically. Please open this URL manually: ${plotUrl}');
                            }
                        }
                        // Delay to avoid pop-up blocker
                        setTimeout(openDashboard, 500);
                    </script>`
                ).setTitle('Opening Dashboard').setWidth(300).setHeight(100);
        ...
        return plotUrl; // Return URL for potential use or logging
    } catch (error) {
