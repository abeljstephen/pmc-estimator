...
function createEstimateSheet(tasks) {
  ...
  // Automatically add PERT calculations here if you have such a function
  // For example: generatePERTSheet(spreadsheet);
...
function doPost(e) {
  try {
    ...
    // OPTIONAL: Automatically generate the calculation sheet
    // If you have a function, uncomment this line:
    // generatePERTSheet(spreadsheet);
